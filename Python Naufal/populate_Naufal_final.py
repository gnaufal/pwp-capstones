from TomeRater_Naufal_final import *
...
#
##Create some books:
book1 = Tome_Rater2.create_book("Society of Mind", 12345658, 450)
novel1 = Tome_Rater2.create_novel("Alice In Wonderland", "Lewis Carroll", 123456, 550)
novel1.set_isbn(9781536831134)
nonfiction1 = Tome_Rater2.create_non_fiction("Automate the Boring Stuff", "Python", "beginner", 1929453, 150)
nonfiction2 = Tome_Rater2.create_non_fiction("Computing Machinery and Intelligence", "AI", "advanced", 11111939, 650)
novel2 = Tome_Rater2.create_novel("The Diamond Age", "Neal Stephenson", 10101011, 750)
novel3 = Tome_Rater2.create_novel("There Will Come Soft Rains", "Ray Bradbury", 10001001, 920)
